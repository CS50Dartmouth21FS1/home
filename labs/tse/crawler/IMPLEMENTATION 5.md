...
The knowledge unit noted that an [implementation spec]({{unit}}/design.md#implementation-spec) may include many topics; not all are relevant to the TSE or the Crawler.
